/* =========================================================
   ...
   - Arrastrar fuera del acuario y soltar = eliminar
...
const Aquarium3D = (() => {
    ...
    const drag = {
        ...
        /*
         * Indica si el puntero está actualmente
         * fuera de la zona visible del acuario.
         */
        outside: false
    };
    ...
    function setupPointerEvents() {
        ...
        /*
         * Importante:
         * Si el ratón sale del canvas seguimos teniendo
         * el estado de arrastre preparado para eliminar
         * cuando se suelte.
         */
        canvas.addEventListener(
            "pointerleave",
    ...
    function handlePointerMove(event) {
        ...
        /*
         * Comprobar si el puntero está fuera
         * de la zona del acuario.
         *
         * getPointerPosition() devuelve valores
         * entre 0 y 1 incluso fuera, por eso aquí
         * necesitamos comprobar la posición real.
         */
        ...
        /*
         * Mientras está fuera NO movemos el objeto
         * a una posición falsa.
         *
         * Esto evita que desaparezca antes de soltar.
         */
        ...
        /*
         * Movimiento normal dentro del acuario.
         */
...
window.Aquarium3D = Aquarium3D; rocas +
   decoración + iluminación + burbujas
